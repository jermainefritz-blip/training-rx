...
export const DAYS=[
  {
    ...
    exercises:[
      {name:"Bench Press", muscle:"Lower/inner chest ★", setsReps:"4×4–6", sets:4, topRep:6, restSecs:150, type:"strength", start:155, inc:5, bar:45},
  ...
  },
  {
    ...
    exercises:[
      {name:"Pull-Up", muscle:"Upper back ★", setsReps:"4×4–6", sets:4, topRep:6, restSecs:150, type:"strength", start:10, inc:5, bw:true},
      {name:"Lat Pulldown", muscle:"Upper back ★", setsReps:"3×6–8", sets:3, topRep:8, restSecs:150, type:"strength", start:145, inc:5},
      {name:"T-Bar Row", muscle:"Traps · rhomboids ★", setsReps:"3×6–8", sets:3, topRep:8, restSecs:150, type:"strength", start:80, inc:5},
  ...
  },
  {
    ...
    finisher:{type:"walk", icon:"🏔️", name:"Incline Walk Finisher", desc:"10 min · 10–12% grade · 3.5 mph"},
    exercises:[
      {name:"Leg Press", muscle:"Quads", setsReps:"4×6–8", sets:4, topRep:8, restSecs:150, type:"strength", start:190, inc:10},
  ...
  },
  {
    ...
    exercises:[
      ...
      {name:"Bent-Over Barbell Row", muscle:"Upper back · traps ★", setsReps:"3×8–10", sets:3, topRep:10, restSecs:150, type:"strength", start:105, inc:5, bar:45},
      {name:"Overhead Press (Barbell)", muscle:"Front delts", setsReps:"4×4–6", sets:4, topRep:6, restSecs:150, type:"strength", start:80, inc:5, bar:45},
